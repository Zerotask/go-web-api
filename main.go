...
func main() {
	...
	router.POST("/tasks", server.createTaskHandler)
	router.GET("/tasks", server.getAllTasksHandler)
	router.DELETE("/tasks", server.deleteAllTasksHandler)
	router.GET("/tasks/:id", server.getTaskHandler)
	router.DELETE("/tasks/:id", server.deleteTaskHandler)
	router.GET("/tags/:tag", server.tagHandler)
